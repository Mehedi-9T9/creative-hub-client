...
import { FaBars, FaServicestack, FaShoppingCart } from "react-icons/fa";
    ...
    return (
        <div className="md:flex">
            ...
            <div className="md:w-[20%] bg-[#FBD062] md:h-screen">
                ...
                <div className="hidden md:block">
                    <NavLink to="/dashboard/servicesList"><li className="flex items-center gap-x-3 text-xl font-poppins px-10 "><FaHandshake /> Services List</li></NavLink>
                    <NavLink to="/dashboard/addService"><li className="flex items-center gap-x-3 text-xl font-poppins px-10 pt-2"> <FaServicestack /> Add Service</li></NavLink>
                    <NavLink to="/dashboard/makeAdmin"><li className="flex items-center gap-x-3 text-xl font-poppins px-10 pt-2"><FaPeopleGroup></FaPeopleGroup> Make Admin</li></NavLink>
                </div>
            </div>
